...
public static class ElementHelper
{
    ...
    public static async SyncTask<bool> OnTakeForUse(this Element element)
    {
        ...
        if (!await _input.Click(MouseButtons.Right, element.GetClientRectCache)) return false;
    ...
    public static async SyncTask<bool> OnTakeForHold(this Element element)
    {
        ...
        if (!await _input.Click(element.GetClientRect())) return false;
    ...
    public static async SyncTask<bool> FastMove(this Element element)
    {
        ...
        if (!await _input.SimulateKeyEvent(Keys.LControlKey, true, false)) return false;
        if (!await _input.Click(element.GetClientRect())) return false;
        if (!await _input.SimulateKeyEvent(Keys.LControlKey, false)) return false;
